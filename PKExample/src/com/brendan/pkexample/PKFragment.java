...
public class PKFragment extends Fragment {
	...
	public static final float INPUT_WIDTH = 0.94f; // defined in terms of screen width
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View viewRoot = inflater.inflate(R.layout.add_credit_card, container,
				false);
		mSaveBtn = (Button) viewRoot.findViewById(R.id.save_btn);
		mAcceptedCardsImg = (ImageView) viewRoot
				.findViewById(R.id.accepted_cards);
	...
	private void setupViews() {
		...
		ViewUtils.setMarginLeft(mAcceptedCardsImg,
				(int) (marginLeft * ViewUtils.getScreenWidth(getActivity())));
	}
